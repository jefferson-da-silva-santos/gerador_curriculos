...
const TEMPLATES = [
  {
    ...
    description: "Coluna lateral com foto",
    accent: "#4f46e5",
  },
  {
    id: "modern",
    name: "Moderno",
    description: "Banner no topo em largura total",
    accent: "#0ea5e9",
  },
  {
    id: "minimal",
    name: "Minimalista",
    description: "Ideal para triagem automática (ATS)",
    accent: "#111827",
  },
  {
    id: "timeline",
    name: "Timeline",
    description: "Experiência em linha do tempo",
    accent: "#16a34a",
  },
  {
    id: "executive",
    name: "Executivo",
    description: "Cabeçalho centralizado e elegante",
    accent: "#a16207",
  },
  {
    id: "compact",
    name: "Compacto",
    description: "Muita informação em 1 página",
    accent: "#7c3aed",
  },
  {
    id: "creative",
    name: "Criativo",
    description: "Banner diagonal colorido",
    accent: "#db2777",
  },
  {
    id: "corporate",
    name: "Corporativo",
    description: "Visual sóbrio e tradicional",
    accent: "#334155",
  },
];
  ...
  return (
    ...
    >
      <div className={styles.navbarInner}>
        ...
        <Link to="/editor" className={styles.navCta}>
          Criar meu currículo
        </Link>
      </div>
    </header>
  ...
  <section id="topo" className={styles.hero}>
    ...
    <div className={styles.heroContent} data-aos="fade-right">
      ...
      <h1 className={styles.heroTitle}>
        ...
        <span className={styles.heroTitleAccent}>pronto agora</span>
      </h1>
      <p className={styles.heroSubtitle}>
        8 modelos prontos, edição em tempo real e pagamento só na hora de
        baixar. Sem plano mensal, sem letrinha miúda — R$ 5 por currículo, via
        Pix ou cartão.
      </p>
      <div className={styles.heroActions}>
        <Link to="/editor" className={styles.btnPrimary}>
...
const Features = () => (
  <section className={styles.features}>
    <div className={styles.sectionHeading} data-aos="fade-up">
      ...
      <h2>
        Feito para quem quer resolver rápido, sem abrir mão de ficar bonito
      </h2>
    </div>
...
const TemplatesShowcase = () => (
  <section id="modelos" className={styles.templatesSection}>
    <div className={styles.sectionHeading} data-aos="fade-up">
      ...
      <p>
        Cada modelo tem seu próprio layout — mudar de um pro outro não apaga o
      ...
      {TEMPLATES.map((template) => (
        <div key={template.id} className={styles.templateCard}>
          <div
            ...
            style={{
              background: `linear-gradient(160deg, ${template.accent}22, ${template.accent}05)`,
            }}
          >
            <div
              className={styles.templateCardBar}
  ...
  const steps = [
    {
      ...
      description:
        "Nome, experiências, formação e competências — arrastando para reordenar do seu jeito.",
    },
    {
      icon: "bx-brush",
      title: "Escolha modelo e cor",
      description:
        "8 layouts e 19 paletas. Troque à vontade, o conteúdo continua o mesmo.",
    },
    {
      icon: "bxl-pix",
      title: "Pague R$ 5 e baixe",
      description:
        "Pix ou cartão, aprovação na hora. O PDF libera assim que o pagamento é confirmado.",
    },
  ];
  ...
  <section id="preco" className={styles.pricing}>
    <div className={styles.pricingCard} data-aos="zoom-in">
      ...
      <ul className={styles.pricingList}>
        <li>
          <i className="bx bx-check" /> Edição ilimitada antes de gerar
        </li>
        <li>
          <i className="bx bx-check" /> 8 modelos + 19 paletas de cor
        </li>
        <li>
          <i className="bx bx-check" /> Upload de foto incluso
        </li>
        <li>
          <i className="bx bx-check" /> Pix ou cartão, aprovação na hora
        </li>
        <li>
          <i className="bx bx-check" /> PDF em alta qualidade
        </li>
      </ul>
      <Link to="/editor" className={styles.btnPrimary}>
        Criar meu currículo
...
const Testimonials = () => (
  <section className={styles.testimonials}>
    <div className={styles.sectionHeading} data-aos="fade-up">
      ...
      <h2>
        Gente que precisava de um currículo rápido — e ficou bonito também
      </h2>
    </div>
...
const FinalCta = () => (
  <section className={styles.finalCta} data-aos="zoom-in">
    ...
    <p>
      Sem cadastro, sem plano mensal. Só R$ 5 quando você realmente for baixar.
    </p>
    <Link to="/editor" className={styles.btnLight}>
      Começar agora <i className="bx bx-right-arrow-alt" />
    </Link>
  </section>
);
...
const Footer = () => (
  <footer className={styles.footer}>
    <div className={styles.footerInner}>
      ...
      <p>
        Feito para quem precisa de um currículo bom, rápido — e sem burocracia.
      </p>
