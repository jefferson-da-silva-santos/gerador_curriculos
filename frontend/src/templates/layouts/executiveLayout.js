...
export const executiveLayout = (fontStyles, rgb) => `
  ...
  * {
  ...
  .ex-header__role { font-size: 1rem; color: #555; margin-top: 0.3rem; letter-spacing: 0.03em; }
  ...
  .ex-contacts a { color: #555; text-decoration: none; }
  ...
  .ex-entry__sub { font-style: italic; color: #555; margin-top: 0.1rem; font-size: 0.87rem; }
